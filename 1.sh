...
##########################################################################################
#                                                                                        
#                🚀 THIS SCRIPT IS PROUDLY CREATED BY **CRYPTO FGA**! 🚀                 
#                                                                                        
#   🌐 Join our revolution in decentralized networks and crypto innovation!               
#                                                                                        
# 📢 Stay updated:                                                                      
#     • Follow us on Telegram: https://t.me/CryptoSikhoOfficial                             
#     • Follow us on X: https://x.com/idkerrors                                         
##########################################################################################
...
if [[ $SYSTEM_TYPE -eq 0 ]]; then
    # VPS
    CONFIG_URL="https://raw.githubusercontent.com/idkerror/Gaia_Node/main/config2.json"
elif [[ $SYSTEM_TYPE -eq 1 ]]; then
    # Laptop
    if ! check_nvidia_gpu; then
        CONFIG_URL="https://raw.githubusercontent.com/idkerror/Gaia_Node/main/config2.json"
    else
        CONFIG_URL="https://raw.githubusercontent.com/idkerror/Gaia_Node/main/config1.json"
    fi
    ...
    if ! check_nvidia_gpu; then
        ...
        CONFIG_URL="https://raw.githubusercontent.com/idkerror/Gaia_Node/main/config3.json"
    fi
fi
...
echo "🌟 Stay connected: Telegram: https://t.me/CryptoSikhoOfficial | Twitter: https://x.com/idkerror"
